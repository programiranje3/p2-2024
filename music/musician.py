...
class Musician:
    ...
    def play(self, song_title, *args, **kwargs):
        ...
        g = ', '.join([a for a in args])
        m = ', '.join([v for _, v in kwargs.items()])
        return f'\'{self.name}\' playing {s}: {rc} ... playing ... {g} {m}'
...
keith = Musician('Keith Relf')
# keith.play_song('For Your Love', 'Thank you!', love='We love you!')
keith.play_song('For Your Love', 'Thank you!',
...
keith = Musician('Keith Relf')
keith_string = str(keith)
print(keith.from_str(keith_string))
