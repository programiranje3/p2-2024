...
class Musician:
    ...
    def __str__(self):
        n = self.name
        b = '(solo musician)' if not self.is_band_member else '(band member)'
        return f'{n} {b}'
    ...
    def play(self, song_title, *args, **kwargs):
        ...
        n = self.name
        t = song_title
        g = ', '.join([m for m in args]) if args else ''
        rc = ''
        if len(kwargs) >= 1:
            rc = kwargs['rhythm_count']
            del kwargs['rhythm_count']
        m = ', '.join([v for k, v in kwargs.items()]) if kwargs else ''

        return f'{rc} {n} playing \'{t}\': ... playing ... {g} {m}'
    ...
    def from_str(cls, musician_string):
        ...
        # b = '(solo musician)' if not self.is_band_member else '(band member)'
        # return f'{n} {b}'
        name, is_band_member = musician_string.split(' (')
        is_band_member = True if is_band_member.startswith('b') else False
        return cls(name, is_band_member)


#%%
# Print objects
keith = Musician('Keith Relf')
print(keith)
...
#%%
# Compare objects
print(keith.__dict__)
print(keith == Musician('Keith Relf'))
...
# Calling methods
keith = Musician('Keith Relf')
print(keith.play('For Your Love', *['Thank you!'], rhythm_count='One, two, three, four!'))
print(keith.play_song('For Your Love', *['Thank you!'], rhythm_count='One, two, three, four!'))
...
keith = Musician('Keith Relf')
print(keith)
print(Musician.from_str(str(keith)))
kr = Musician.from_str(str(keith))
print(kr)
print(Musician.from_str(str(keith)) == keith)
print(kr == keith)
...
class Songwriter(Musician):
    ...
    def __str__(self):
        return f'{super().__str__()}, {self.instrument.name.lower().replace("_", " ")}'
...
# print()
jeff = Songwriter(name='Jeff Beck', instrument=Instrument.LEAD_GUITAR)
print(jeff)
print(jeff == Songwriter(name='Jeff Beck', instrument=Instrument.LEAD_GUITAR))
print(jeff.what_do_you_do())

#%%
# Demonstrate method overriding
keith = Singer(name='Keith Relf', vocals=Vocals.LEAD_VOCALS)
print(keith.play('For Your Love', 'Thank you!',
                 rhythm_count='One, two, three, four!', thanks='Thank you!'))
